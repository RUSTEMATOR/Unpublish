...
import {USER_ACCOUTNS, VIP_ONLY} from "../../src/Data/UserAccounts";
...
const vipPageUrl = 'https://www.kingbillycasino.com/promotions?vip'
...
test.describe('Vip page unpublish test', () => {
    ...
    for (const [status, creds] of Object.entries(VIP_ONLY)) {
